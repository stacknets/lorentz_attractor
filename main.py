...
# we are gonna visualize the Lorenz attractor. enjoy!!
    ...
    def game(self):
        ...
        while running: 
            ...
            if pressed_s and pressed_a:
                # generate 3 points at the locs: (x0,y0), (x1, y1), (x2, y2) for every update 
                try: 
...
if __name__ == '__main__':
    ...
    print('PLOTTING OBJECT INITIALIZING SUCCESSFULLY')
